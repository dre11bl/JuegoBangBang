...
function siguientePersonaje(){
    ...
    document.getElementById('imgpersonaje').src="img/p"+ personajeActual +".png";
...
function comenzarJuego(){
    ...
    setTimeout(
        function(){
            window.location.assign('juego2.html');
        },2000)
...
function cargarEscenario(){
    if(!localStorage.getItem('marcador1')){
        localStorage.getItem('marcador1','0');
        localStorage.getItem('marcador2','0');
    ...
    document.querySelector('.p1').style.backgroundImage = "url(img/p"+localStorage.getItem('personaje1',personajeActual)+".png)";
    document.querySelector('.p2').style.backgroundImage = "url(img/p"+localStorage.getItem('personaje2',personajeActual)+".png)";
...
function disparo1(){
    ...
    //modificamos la posición del jugador
